...
<tr><th>Branch</th><td><a href="https://github.com/personalcore/storagecore/tree/{{ .Branch }}">{{ .Branch }}</a></td></tr>
{{ if .Commit}}<tr><th>Commit</th><td><a href="https://github.com/personalcore/storagecore/commit/{{ .Commit }}">{{ .Commit }}</a></td></tr>{{ end }}
