...
#
# example usage: 
# $GOPATH/src/github.com/personalcore/storagecore/cmd/info/test.sh --list | \
#   parallel -P20 $GOPATH/src/github.com/personalcore/storagecore/cmd/info/test.sh

export PATH=$GOPATH/src/github.com/personalcore/storagecore:$PATH
